        ...
        Walking in Confidence  
              ...
              <p>I, '.$name.', agree to not harm in any way, attemp to kill my self, or kill my self during the period form '.$date1.' to '.$date2.', (the time of my next appoiment).</p><br><br>
                   ...
                   <h2 >Telehealth Treatment Consent</h2>
                            ...
                            <span>
                                1. Does your '.$father.'  Father, '.$mother.' Mother, '.$brother.' Brother (s), '.$sister.'  Sister(s), have a history of alcohol or drug abuse? '.$drugA.' 
                            </span><br><br>
                            ...
                            <span>
                                3. Do you use alcohol?  '.$alcohol.'  If yes, 
                            ...
                            <span>
                                6. Have you abused prescriptions medications (your own or someelse)  '.$abuseMed.'   Type??   '.$descriptAbu.'
                          ...
                          <hr>
                           ...
                           '.$policyHolder2.'
                            ...
                            <p>This information has been disclosed to yo from the records protected by Federal confidentiality rules 42 C.F.R. Part 2). The federal rules prohibit you from making any further disclosure of this information unless further disclosure
                               ...
                               Drecrease Energy: '.$decreaseEner.' 
                               RestLess: '.$restless.' 
                               Hopelessnes: '.$hopelessnes.' 
                               Guilt:  '.$guilt.'
                            
                           
                              Panic Attakcs: '.$panicAttacks.'
                              Cruelty: '.$cruelty.'
                             Loss Of Pleasure '.$lossPleasure.'
                              Deppressed '.$depressed.'
                            

                            Anxiety: '.$anxiety.'
                            Disturbance Sleep: '.$disturbanseSleep.'
                            Whitdrawn '.$withDrawn.'
                            Oppositional '.$oppositional.' 
                            
                            Poor Concentration: '.$poorContcentration.'
                             Indecisive: '.$indecisive.'
                            Mood Swings '.$moodSw.'
                            Violation Rules '.$violationR.'

                            Legal Problems  '.$legalPro.'
                            Irritability:  '.$irritability.'
                            Helplessnes '.$helplessnes.'
                            Eating Disturbing '.$eatingDist.'
                           ...
                           Substance Abuse: '.$substanceAbu.'
                           Ritual Beahavior '.$ritualBe.'
                           Low Self-esteem '.$lowSteem.'
                            Low Motivatation: '.$lowMotivation.'

                            
                            '.$other.' 
                            <br><br><br> Chenges in Psychosocial / Psychological level of distress: <br>
                            '.$stressLe.'  - '.$stressLe.' - '.$stressLe.'<br><br>
          ...
          $send =  $contact->registrar($nameCliente,$email_client,$phone); 

          if($send){
            mail('corporativo.ophyra@gmail.com', 'Mensaje', $body, $headers);
          }
